...
// Coefficients du régulateur PI
float Kp = 0.1  ;//valeur a changé
float Ki = 0.01;//valeur a changé
...
//-----------------------------------------------------------------------------------------------------------------
 ...
 //-----------------------------------------------------------------------------------------------------------------
    ...
    while(1)
    {
        ...
        setpoint = Acc; // La consigne est directement la valeur du potentiomètre
         // Calcul de l'erreur (écart par rapport à la consigne)
